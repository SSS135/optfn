...
class SNES:
    def __init__(self,
        ...
        self.epoch = 0
        self._momentum_buf = np.zeros_like(self.cur_solution)
    ...
    def _step(self):
        if self._samples is not None:
            ...
            self._momentum_buf *= self.momentum
            self._momentum_buf += self.grad_mean
            self.cur_solution += self.lr * self._momentum_buf
